...
describe('calcularPrestacoes', () => {
  ...
  test('Atividade 02 - O montante deve ser maior que 0', () => {
    // Given
    const montante = 0
    const numeroPrestacoes = 2
   ...
   test('Atividade 02 - O número de prestações deve ser maior que 0', () => {
    // Given
    const montante = 2
  ...
  test('Atividade 02 - O número de prestações deve ser inteiro', () => {
    // Given
    const montante = 2
